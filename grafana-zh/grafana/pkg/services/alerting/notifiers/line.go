...
func init() {
    ...
    <div class="gf-form-group">
      <h3 class="page-heading">行通知设置</h3>
      <div class="gf-form">
        <span class="gf-form-label width-14">令牌</span>
        <input type="text" required class="gf-form-input max-width-22" ng-model="ctrl.model.settings.token" placeholder="行通知令牌密钥"></input>
      </div>
    </div>
`,
	})
